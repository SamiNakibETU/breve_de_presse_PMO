...
async def init_db() -> None:
    ...
    async with engine.begin() as conn:
        ...
        for stmt in [
            ...
            (
                "ALTER TABLE editions ADD COLUMN IF NOT EXISTS "
            ...
            "ALTER TABLE articles ADD COLUMN IF NOT EXISTS analysis_version VARCHAR(64)",
            "ALTER TABLE articles ALTER COLUMN analysis_version TYPE VARCHAR(64)",
